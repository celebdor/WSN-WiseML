"""
This file is part of WSN-WiseML. Originally made by Sander Marechal for the Lone Wolves blog
...
class Daemon:
    ...
    def dropPrivileges(self):
        """
        You should override this method when you subclass Daemon. It will be called after the process done the
        Double fork.
        """
